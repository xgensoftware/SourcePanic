...
import com.slobodastudio.smspanic.widget.APrefSmsWidget;

public class PanicWidgetModelLarge extends APrefSmsWidget {
	...
	private static String PANIC_WIDGET_PROVIDER_NAME = "com.slobodastudio.smspanic.widgetlarge.SmsWidgetProviderLarge";
	...
	public PanicWidgetModelLarge(int instanceId) {

		super(instanceId);
	}

	public PanicWidgetModelLarge(int instanceId, String inNumber, String mesText, int messageId,
	...
	public static PanicWidgetModelLarge retrieveModel(Context ctx, int widgetId) {

		PanicWidgetModelLarge m = new PanicWidgetModelLarge(widgetId);
	...
	public void setValueForPref(String key, String value) {
		...
		if (key.equals(getStoredKeyForFieldName(PanicWidgetModelLarge.F_PHONENUM))) {
			phoneNum = value;
			return;
		}
		if (key.equals(getStoredKeyForFieldName(PanicWidgetModelLarge.F_TEXT))) {
			Text = value;
			return;
		}
		if (key.equals(getStoredKeyForFieldName(PanicWidgetModelLarge.F_MESSAGE))) {
			messageId = Integer.parseInt(value);
			return;
		}
		if (key.equals(getStoredKeyForFieldName(PanicWidgetModelLarge.WIDGET_CLICK_ONES))) {
			clickOnes = Integer.parseInt(value);
			return;
		}
		if (key.equals(getStoredKeyForFieldName(PanicWidgetModelLarge.WIDGET_NAME))) {
			widgetName = value;
			return;
		}
	}
